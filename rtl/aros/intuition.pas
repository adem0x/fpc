...
function ActivateGadget(Gadget: PGadget; Window: PWindow; Requester: PRequester): LongBool; // 77
procedure ActivateWindow(Window: PWindow); // 75
procedure AddClass(ClassPtr: PIClass); // 114
function AddGadget(Window: PWindow; Gadget: PGadget; Position: LongWord): Word; // 7
function AddGList(Window: PWindow; Gadget: PGadget; Position: LongWord; NumGad: LongInt; Requester: PRequester): Word; // 73
function AllocIntuiMessage(Window: PWindow): PIntuiMessage; // 148
function AllocRemember(var RememberKey: PRemember; Size: LongWord; Flags: LongWord): APTR; // 66
function AllocScreenBuffer(Screen: PScreen; Bitmap: PBitMap; Flags: LongWord): PScreenBuffer; // 128
procedure AlohaWorkbench(MsgPort: PMsgPort); // 67
function AutoRequest(Window: PWindow; Body: PIntuiText; PosText: PIntuiText; NegText: PIntuiText; PFlag: LongWord; NFlag: LongWord; Width: LongWord; Height: LongWord): LongBool; // 58
procedure BeginRefresh(Window: PWindow); // 59
function BuildEasyRequestArgs(Window: PWindow; EasyStruct: PEasyStruct; IDCMP: LongWord; Args: APTR): PWindow; // 99
function BuildSysRequest(Window: PWindow; Body: PIntuiText; PosText: PIntuiText; NegText: PIntuiText; Flags: LongWord; Width: LongWord; Height: LongWord): PWindow; // 60
function ChangeScreenBuffer(Screen: PScreen; ScreenBuffer: PScreenBuffer): LongWord; // 130
procedure ChangeWindowBox(Window: PWindow; Left: LongInt; Top: LongInt; Width: LongInt; Height: LongInt); // 81
function ClearDMRequest(Window: PWindow): LongBool; // 8
procedure ClearMenuStrip(Window: PWindow); // 9
procedure ClearPointer(Window: PWindow); // 10
function CloseScreen(Screen: PScreen): LongBool; // 11
procedure CloseWindow(Window: PWindow); // 12
function CloseWorkBench: LongInt; // 13
procedure ChangeDecoration(ID: LongWord; Decor: PNewDecorator); // 153
function ChangeWindowShape(Window: PWindow; NewShape: PRegion; CallBack: PHook): PRegion; unimplemented; // 143
procedure CurrentTime(var Seconds: LongWord; var Micros: LongWord); // 14
function DisplayAlert(AlertNumber: LongWord; String_: PChar; Height: Word): LongBool; deprecated; // 15
procedure DisplayBeep(Screen: PScreen); // 16
procedure DisposeObject(Object_: APTR); // 107
function DoGadgetMethodA(Gad: PGadget; Win: PWindow; Req: PRequester; Msg: TMsg): IPTR; // 135
function DoNotify(Cl: PIClass; O: PObject_; Ic: Pointer; Msg: TopUpdate): Pointer;
function DoubleClick(SSeconds: LongWord; SMicros: LongWord; CSeconds: LongWord; CMicros: LongWord): LongBool; // 17
procedure DrawBorder(Rp: PRastPort; Border: PBorder; LeftOffset: LongInt; TopOffset: LongInt); // 18
procedure DrawImage(Rp: PRastPort; Image: PImage; LeftOffset: LongInt; TopOffset: LongInt); // 19
procedure DrawImageState(Rp: PRastPort; Image: PImage; LeftOffset: LongInt; TopOffset: LongInt; state: LongWord; DrawInfo: PDrawInfo); // 103
function EasyRequestArgs(Window: PWindow; EasyStruct: PEasyStruct; IDCMP_Ptr: PLongWord; Args: APTR): LongInt; // 98
procedure EndRefresh(Window: PWindow; Complete: LongBool); // 61
procedure EndRequest(Requester: PRequester; Window: PWindow); // 20
function EndScreenNotify(Notify: IPTR): LongBool;
procedure EraseImage(Rp: PRastPort; Image: PImage; LeftOffset: LongInt; TopOffset: LongInt); // 105
function FindClass(ClassID: ClassID): PIClass; // 112
function FreeClass(IClass: PIClass): LongBool; // 119
procedure FreeICData(ICData: Pointer); // 146
procedure FreeIntuiMessage(IMsg: PIntuiMessage); // 149
procedure FreeMonitorList(Obj: PPObject_); // 164
procedure FreeRemember(var RememberKey: PRemember; ReallyForget: LongInt); // 68
procedure FreeScreenBuffer(Screen: PScreen; ScreenBuffer: PScreenBuffer); // 129
procedure FreeScreenDrawInfo(Screen: PScreen; DrawInfo: PDrawInfo); // 116
procedure FreeSysRequest(Window: PWindow); // 62
procedure GadgetMouse(Gadget: PGadget; GInfo: PGadgetInfo; var MousePoint: SmallInt); // 95
function GetAttr(AttrID: LongWord; Object_: PObject_; StoragePtr: PIPTR): LongWord; // 109
function GetDefaultPubScreen(NameBuffer: PChar): PScreen; // 97
function GetDefPrefs(Preferences: PPreferences; Size: SmallInt): PPreferences; // 21
function GetMonitorList(Tags: PTagItem): PPObject_;
function GetPrefs(Preferences: PPreferences; Size: SmallInt): PPreferences; // 22
function GetScreenData(Buffer: APTR; Size: LongWord; Type_: LongWord; Screen: PScreen): LongInt;
function GetScreenDrawInfo(Screen: PScreen): PDrawInfo; // 115
procedure HelpControl(Window: PWindow; Flags: LongWord); // 138
procedure HideWindow(Window: PWindow); // 141
procedure InitRequester(Requester: PRequester); deprecated; // 23
function IntuiTextLength(iText: PIntuiText): LongInt; // 55
function ItemAddress(MenuStrip: PMenu; MenuNumber: Word): PMenuItem; // 24
function IsWindowVisible(Window: PWindow): LongWord; // 139
procedure LendMenus(FromWindow: PWindow; ToWindow: PWindow); // 134
function LockIBase(LockNumber: LongWord): LongWord; // 69
function LockPubScreen(const Name: STRPTR): PScreen; // 85
function LockPubScreenList: PList; // 87
function MakeClass(ClassID: ClassID; SuperClassID: ClassID; SuperClassPtr: PIClass; InstanceSize: LongWord; Flags: LongWord): PIClass; // 113
function MakeScreen(Screen: PScreen): LongInt; // 63
function ModifyIDCMP(Window: PWindow; Flags: LongWord): LongBool; // 25
procedure ModifyProp(Gadget: PGadget; Window: PWindow; Requester: PRequester; Flags: LongWord; HorizPot: LongWord; VertPot: LongWord; HorizBody: LongWord; VertBody: LongWord); // 26
procedure MoveScreen(Screen: PScreen; Dx: LongInt; Dy: LongInt); // 27
procedure MoveWindow(Window: PWindow; Dx: LongInt; Dy: LongInt); // 28
procedure MoveWindowInFrontOf(Window: PWindow; BehindWindow: PWindow); // 80
procedure NewModifyProp(Gadget: PGadget; Window: PWindow; Requester: PRequester; Flags: LongWord; HorizPot: LongWord; VertPot: LongWord; HorizBody: LongWord; VertBody: LongWord; NumGad: LongInt); // 78
function NewObjectA(ClassPtr: PIClass; ClassID: PChar; TagList: PTagItem): APTR; // 106
function NextObject(ObjectPtrPtr: APTR): APTR; //  111
function NextPubScreen(Screen: PScreen; Namebuf: PChar): PChar; // 89
function ObtainGIRPort(GInfo: PGadgetInfo): PRastPort; // 93
procedure OffGadget(Gadget: PGadget; Window: PWindow; Requester: PRequester); // 29
procedure OffMenu(Window: PWindow; MenuNumber: Word); // 30
procedure OnGadget(Gadget: PGadget; Window: PWindow; Requester: PRequester); // 31
procedure OnMenu(Window: PWindow; MenuNumber: Word); // 32
function OpenScreen(NewScreen: PNewScreen): PScreen; // 33
function OpenScreenTagList(NewScreen: PNewScreen; TagList: PTagItem): PScreen; // 102
function OpenWindow(NewWindow: PNewWindow): PWindow; // 34
function OpenWindowTagList(NewWindow: PNewWindow; TagList: PTagItem): PWindow; // 101
function OpenWorkBench: IPTR; // 35
function PointInImage(Point: LongWord; Image: PImage): LongBool; // 104
procedure PrintIText(Rp: PRastPort; IText: PIntuiText; Left: LongInt; Top: LongInt); // 36
function PubScreenStatus(Screen: PScreen; StatusFlags: Word): Word; // 92
function QueryOverscan(DisplayID: LongWord; Rect: PRectangle; OScanType: SmallInt): LongInt; // 79
procedure RefreshGadgets(Gadgets: PGadget; Window: PWindow; Requester: PRequester); // 37
procedure RefreshGList(Gadgets: PGadget; Window: PWindow; Requester: PRequester; NumGad: LongInt); // 72
procedure RefreshWindowFrame(Window: PWindow); // 76
procedure ReleaseGIRPort(Rp: PRastPort); // 94
function RemakeDisplay: LongInt; // 64
procedure RemoveClass(ClassPtr: PIClass); // 118
function RemoveGadget(Window: PWindow; Gadget: PGadget): Word; // 38
function RemoveGList(RemPtr: PWindow; Gadget: PGadget; NumGad: LongInt): Word; // 74
procedure ReportMouse(Flag: LongInt; Window: PWindow); // 39
function Request(Requester: PRequester; Window: PWindow): LongBool; // 40
function ResetMenuStrip(Window: PWindow; Menu: PMenu): LongBool; // 117
function RethinkDisplay: LongInt; // 65
procedure ScreenDepth(Screen: PScreen; Flags: LongWord; Reserved: APTR); // 131
procedure ScreenPosition(Screen: PScreen; Flags: LongWord; X1: LongInt; Y1: LongInt; X2: LongInt; Y2: LongInt); // 132
procedure ScreenToBack(Screen: PScreen); // 41
procedure ScreenToFront(Screen: PScreen); // 42
procedure ScrollWindowRaster(Win: PWindow; Dx: SmallInt; Dy: SmallInt; XMin: SmallInt; YMin: SmallInt; XMax: SmallInt; YMax: SmallInt); // 133
procedure ScrollWindowRasterNoFill(Window: PWindow; Dx, Dy, XMin, YMin, XMax, YMax: Word); // 159
procedure SendIntuiMessage(Window: PWindow; IMsg: PIntuiMessage); // 151
function SetAttrsA(Object_: APTR; TagList: PTagItem): IPTR; // 108
procedure SetDefaultPubScreen(Name: PChar); // 90
procedure SetDefaultScreenFont(TextFont: PTextFont); // 144
function SetDMRequest(Window: PWindow; Requester: PRequester): LongBool; // 43
function SetEditHook(Hook: PHook): PHook; // 82
function SetGadgetAttrsA(Gadget: PGadget; Window: PWindow; Requester: PRequester; TagList: PTagItem): IPTR;
function SetIPrefs(Data: Pointer; Length: LongWord; Typ: LongWord): LongWord; // 96
function SetMenuStrip(Window: PWindow; Menu: PMenu): LongBool; // 44
function SetMouseQueue(Window: PWindow; QueueLength: LongWord): LongInt; // 83
procedure SetPointer(Window: PWindow; Pointer_: PWord; Height: LongInt; Width: LongInt; XOffset: LongInt; YOffset: LongInt); // 45
function SetPointerBounds(Screen: PScreen; Rect: TRectangle; Reserved: LongWord; Tags: PTagItem): LongWord; // 160
function SetPrefs(PrefBuffer: PPreferences; Size: LongInt; Inform: LongBool): PPreferences; // 54
function SetPubScreenModes(Modes: Word): Word; // 91
procedure SetWindowPointerA(Win: PWindow; Taglist: PTagItem); // 136
procedure SetWindowTitles(Window: PWindow; const WindowTitle: PChar; const ScreenTitle: PChar); // 46
procedure ShowTitle(Screen: PScreen; ShowIt: LongBool); // 47
procedure ShowWindow(Window: PWindow); // 140
procedure SizeWindow(Window: PWindow; Dx: LongInt; Dy: LongInt); // 48
function StartScreenNotifyTagList(Tags: PTagItem): IPTR; // 161
function SysReqHandler(Window: PWindow; IDCMPFlagsPtr: PLongWord; WaitInput: LongBool): LongInt; // 100
function TimedDisplayAlert(AlertNumber: LongWord; String_: PChar; Height: Word; Time: LongWord): LongBool; // 137
procedure UnlockIBase(LockNumber: LongWord); // 70
procedure UnlockPubScreen(Name: PChar; Screen: PScreen); // 86
procedure UnlockPubScreenList; // 88
function ViewAddress: PView; // 49
function ViewPortAddress(Window: PWindow): PViewPort; // 50
function WBenchToBack: LongBool; // 56
function WBenchToFront: LongBool; // 57
procedure WindowAction(Window: PWindow; Action: LongWord; Tags: PTagItem); // 157
function WindowLimits(Window: PWindow; WidthMin: SmallInt; HeightMin: SmallInt; WidthMax: Word; HeightMax: Word): LongBool; // 53
procedure WindowToBack(Window: PWindow); // 51
procedure WindowToFront(Window: PWindow); // 52
procedure ZipWindow(Window: PWindow); // 84
...
function ClearDMRequest(Window: PWindow): LongBool;
type
  TLocalCall = function(Window: PWindow; Base: Pointer): LongBool; cdecl;
var
  Call: TLocalCall;
begin
...
function CloseScreen(Screen: PScreen): LongBool;
type
  TLocalCall = function(Screen: PScreen; Base: Pointer): LongBool; cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(IntuitionBase, 11));
  CloseScreen := Call(Screen, IntuitionBase);
end;
...
function DisplayAlert(AlertNumber: LongWord; String_: PChar; Height: Word): LongBool;
type
  TLocalCall = function(AlertNumber: LongWord; String_: PChar; Height: Word; Base: Pointer): LongBool; cdecl;
var
  Call: TLocalCall;
begin
...
function DoubleClick(SSeconds: LongWord; SMicros: LongWord; CSeconds: LongWord; CMicros: LongWord): LongBool;
type
  TLocalCall = function(SSeconds: LongWord; SMicros: LongWord; CSeconds: LongWord; CMicros: LongWord; Base: Pointer): LongBool; cdecl;
var
  Call: TLocalCall;
begin
...
type
  TLocalCall = procedure(Rp: PRastPort; Border: PBorder; LeftOffset: LongInt; TopOffset: LongInt; Base: Pointer); cdecl;
var
  Call: TLocalCall;
begin
...
function GetDefPrefs(Preferences: PPreferences; Size: SmallInt): PPreferences;
type
  TLocalCall = function(Preferences: PPreferences; Size: SmallInt; Base: Pointer): PPreferences; cdecl;
var
  Call: TLocalCall;
begin
...
function GetPrefs(Preferences: PPreferences; Size: SmallInt): PPreferences;
type
  TLocalCall = function(Preferences: PPreferences; Size: SmallInt; Base: Pointer): PPreferences; cdecl;
var
  Call: TLocalCall;
...
function ItemAddress(MenuStrip: PMenu; MenuNumber: Word): PMenuItem;
type
  TLocalCall = function(MenuStrip: PMenu; MenuNumber: Word; Base: Pointer): PMenuItem; cdecl;
var
  Call: TLocalCall;
begin
...
function ModifyIDCMP(Window: PWindow; Flags: LongWord): LongBool;
type
  TLocalCall = function(Window: PWindow; Flags: LongWord; Base: Pointer): LongBool; cdecl;
var
  Call: TLocalCall;
begin
...
procedure OffMenu(Window: PWindow; MenuNumber: Word);
type
  TLocalCall = procedure(Window: PWindow; MenuNumber: Word; Base: Pointer); cdecl;
var
  Call: TLocalCall;
begin
...
type
  TLocalCall = procedure(Gadget: PGadget; Window: PWindow; Requester: PRequester; Base: Pointer); cdecl;
var
  Call: TLocalCall;
begin
...
procedure OnMenu(Window: PWindow; MenuNumber: Word);
type
  TLocalCall = procedure(Window: PWindow; MenuNumber: Word; Base: Pointer); cdecl;
var
  Call: TLocalCall;
...
function OpenWorkBench: IPTR;
type
  TLocalCall = function(Base: Pointer): IPTR; cdecl;
var
  Call: TLocalCall;
begin
...
function Request(Requester: PRequester; Window: PWindow): LongBool;
type
  TLocalCall = function(Requester: PRequester; Window: PWindow; Base: Pointer): LongBool; cdecl;
var
  Call: TLocalCall;
begin
...
function SetDMRequest(Window: PWindow; Requester: PRequester): LongBool;
type
  TLocalCall = function(Window: PWindow; Requester: PRequester; Base: Pointer): LongBool; cdecl;
var
  Call: TLocalCall;
begin
...
function SetMenuStrip(Window: PWindow; Menu: PMenu): LongBool;
type
  TLocalCall = function(Window: PWindow; Menu: PMenu; Base: Pointer): LongBool; cdecl;
var
  Call: TLocalCall;
begin
...
procedure ShowTitle(Screen: PScreen; ShowIt: LongBool);
type
  TLocalCall = procedure(Screen: PScreen; ShowIt: LongBool; Base: Pointer); cdecl;
var
  Call: TLocalCall;
begin
...
function WindowLimits(Window: PWindow; WidthMin: SmallInt; HeightMin: SmallInt; WidthMax: Word; HeightMax: Word): LongBool;
type
  TLocalCall = function(Window: PWindow; WidthMin: SmallInt; HeightMin: SmallInt; WidthMax: Word; HeightMax: Word; Base: Pointer): LongBool; cdecl;
var
  Call: TLocalCall;
begin
...
function SetPrefs(PrefBuffer: PPreferences; Size: LongInt; Inform: LongBool): PPreferences;
type
  TLocalCall = function(PrefBuffer: PPreferences; Size: LongInt; Inform: LongBool; Base: Pointer): PPreferences; cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(IntuitionBase, 54));
  Result := Call(PrefBuffer, Size, Inform, IntuitionBase);
end;

function IntuiTextLength(IText: PIntuiText): LongInt;
type
  TLocalCall = function(IText: PIntuiText; Base: Pointer): LongInt; cdecl;
var
  Call: TLocalCall;
begin
...
type
  TLocalCall = function(Base: Pointer): LongBool; cdecl;
var
  Call: TLocalCall;
begin
...
function AutoRequest(Window: PWindow; Body: PIntuiText; PosText: PIntuiText; NegText: PIntuiText; PFlag: LongWord; NFlag: LongWord; Width: LongWord; Height: LongWord): LongBool;
type
  TLocalCall = function(Window: PWindow; Body: PIntuiText; PosText: PIntuiText; NegText: PIntuiText; PFlag: LongWord; NFlag: LongWord; Width: LongWord; Height: LongWord; Base: Pointer): LongBool; cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(IntuitionBase, 58));
  Result := Call(Window, Body, PosText, NegText, PFlag, NFlag, Width, Height, IntuitionBase);
end;
...
function BuildSysRequest(Window: PWindow; Body: PIntuiText; PosText: PIntuiText; NegText: PIntuiText; Flags: LongWord; Width: LongWord; Height: LongWord): PWindow;
type
  TLocalCall = function(Window: PWindow; Body: PIntuiText; PosText: PIntuiText; NegText: PIntuiText; Flags: LongWord; Width: LongWord; Height: LongWord; Base: Pointer): PWindow; cdecl;
var
  Call: TLocalCall;
begin
...
procedure EndRefresh(Window: PWindow; Complete: LongBool);
type
  TLocalCall = procedure(Window: PWindow; Complete: LongBool; Base: Pointer); cdecl;
var
  Call: TLocalCall;
begin
...
function AllocRemember(var RememberKey: PRemember; Size: LongWord; Flags: LongWord): APTR;
type
  TLocalCall = function(var RememberKey: PRemember; Size: LongWord; Flags: LongWord; Base: Pointer): APTR; cdecl;
var
  Call: TLocalCall;
begin
...
function GetScreenData(Buffer: APTR; Size: LongWord; Type_: LongWord; Screen: PScreen): LongInt;
type
  TLocalCall = function(Buffer: APTR; Size: LongWord; Type_: LongWord; Screen: PScreen; Base: Pointer): LongInt; cdecl;
var
  Call: TLocalCall;
begin
...
function ActivateGadget(Gadget: PGadget; Window: PWindow; Requester: PRequester): LongBool;
type
  TLocalCall = function(Gadget: PGadget; Window: PWindow; Requester: PRequester; Base: Pointer): LongBool; cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(IntuitionBase, 77));
  Result := Call(Gadget, Window, Requester, IntuitionBase);
end;
...
function QueryOverscan(DisplayID: LongWord; Rect: PRectangle; OScanType: SmallInt): LongInt;
type
  TLocalCall = function(DisplayID: LongWord; Rect: PRectangle; OScanType: SmallInt; Base: Pointer): LongInt; cdecl;
var
  Call: TLocalCall;
begin
...
type
  TLocalCall = procedure(Window: PWindow; Left: LongInt; Top: LongInt; Width: LongInt; Height: LongInt; Base: Pointer); cdecl;
var
  Call: TLocalCall;
begin
...
function LockPubScreen(const Name: STRPTR): PScreen;
type
  TLocalCall = function(const Name: STRPTR; Base: Pointer): PScreen; cdecl;
var
  Call: TLocalCall;
begin
...
type
  TLocalCall = procedure(Name: PChar; Screen: PScreen; Base: Pointer); cdecl;
var
  Call: TLocalCall;
begin
...
type
  TLocalCall = function(Screen: PScreen; Namebuf: PChar; Base: Pointer): PChar; cdecl;
var
  Call: TLocalCall;
begin
...
type
  TLocalCall = procedure(Name: PChar; Base: Pointer); cdecl;
var
  Call: TLocalCall;
begin
...
type
  TLocalCall = function(Modes: Word; Base: Pointer): Word; cdecl;
var
  Call: TLocalCall;
begin
...
function PubScreenStatus(Screen: PScreen; StatusFlags: Word): Word;
type
  TLocalCall = function(Screen: PScreen; StatusFlags: Word; Base: Pointer): Word; cdecl;
var
  Call: TLocalCall;
begin
...
procedure GadgetMouse(Gadget: PGadget; GInfo: PGadgetInfo; var MousePoint: Smallint);
type
  TLocalCall = procedure(Gadget: PGadget; GInfo: PGadgetInfo; var MousePoint: SmallInt; Base: Pointer); cdecl;
var
  Call: TLocalCall;
begin
...
function GetDefaultPubScreen(NameBuffer: PChar): PScreen;
type
  TLocalCall = function(NameBuffer: PChar; Base: Pointer): PScreen; cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(IntuitionBase, 97));
  GetDefaultPubScreen := Call(NameBuffer, IntuitionBase);
end;

function EasyRequestArgs(Window: PWindow; EasyStruct: PEasyStruct; IDCMP_Ptr: PLongWord; Args: APTR): LongInt;
type
  TLocalCall = function(Window: PWindow; EasyStruct: PEasyStruct; IDCMP_Ptr: PLongWord; Args: APTR; Base: Pointer): LongInt; cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(IntuitionBase, 98));
  EasyRequestArgs := Call(Window, EasyStruct, IDCMP_Ptr, Args, IntuitionBase);
end;

function BuildEasyRequestArgs(Window: PWindow; EasyStruct: PEasyStruct; IDCMP: LongWord; Args: APTR): PWindow;
type
  TLocalCall = function(Window: PWindow; EasyStruct: PEasyStruct; IDCMP: LongWord; Args: APTR; Base: Pointer): PWindow; cdecl;
var
  Call: TLocalCall;
begin
...
function SysReqHandler(Window: PWindow; IDCMPFlagsPtr: PLongWord; WaitInput: LongBool): LongInt;
type
  TLocalCall = function(Window: PWindow; IDCMPFlagsPtr: PLongWord; WaitInput: LongBool; Base: Pointer): LongInt; cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(IntuitionBase, 100));
  Result := Call(Window, IDCMPFlagsPtr, WaitInput, IntuitionBase);
end;

function OpenWindowTagList(NewWindow: PNewWindow; TagList: PTagItem): PWindow;
type
  TOpenWindowTagList = function(NewWindow: PNewWindow;TagList: PTagItem; Base: Pointer): PWindow; cdecl;
var
...
type
  TLocalCall = function(NewScreen: PNewScreen; TagList: PTagItem; Base: Pointer): PScreen; cdecl;
var
  Call: TLocalCall;
begin
...
procedure DrawImageState(Rp: PRastPort; Image: PImage; LeftOffset: LongInt; TopOffset: LongInt; State: LongWord; DrawInfo: PDrawInfo);
type
  TLocalCall = procedure(Rp: PRastPort; Image: PImage; LeftOffset: LongInt; TopOffset: LongInt; State: LongWord; DrawInfo: PDrawInfo; Base: Pointer); cdecl;
var
  Call: TLocalCall;
begin
...
function PointInImage(Point: LongWord; Image: PImage): LongBool;
type
  TLocalCall = function(Point: LongWord; Image: PImage; Base: Pointer): LongBool; cdecl;
var
  Call: TLocalCall;
begin
...
function NewObjectA(ClassPtr: PIClass; ClassID: PChar; TagList: PTagItem): APTR;
type
  TLocalCall = function(ClassPtr: PIClass; ClassID: PChar; TagList: PTagItem; Base: Pointer): APTR; cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(IntuitionBase, 106));
  Result := Call(ClassPtr, ClassID, TagList, IntuitionBase);
end;

procedure DisposeObject(Object_: APTR);
type
  TLocalCall = procedure(Object_: APTR; Base: Pointer); cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(IntuitionBase, 107));
  Call(Object_, IntuitionBase);
end;

function SetAttrsA(Object_: APTR; TagList: PTagItem): IPTR;
type
  TLocalCall = function(Object_: APTR; TagList: PTagItem; Base: Pointer): IPTR; cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(IntuitionBase, 108));
  Result := Call(Object_, TagList, IntuitionBase);
end;

function GetAttr(AttrID: LongWord; Object_: PObject_; StoragePtr: PIPTR): LongWord;
type
  TLocalCall = function(AttrID: LongWord; Object_: PObject_; StoragePtr: PIPTR; Base: Pointer): LongWord; cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(IntuitionBase, 109));
  Result := Call(attrID,  Object_, storagePtr, IntuitionBase);
end;

function SetGadgetAttrsA(Gadget: PGadget; Window: PWindow; Requester: PRequester; TagList: PTagItem): IPTR;
type
  TLocalCall = function(Gadget: PGadget; Window: PWindow; Requester: PRequester; TagList: PTagItem; Base: Pointer): IPTR; cdecl;
var
  Call: TLocalCall;
begin
...
function NextObject(ObjectPtrPtr: APTR): APTR;
type
  TLocalCall = function(ObjectPtrPtr: APTR; Base: Pointer): APTR; cdecl;
var
  Call: TLocalCall;
begin
...
function FindClass(ClassID: ClassID): PIClass;
type
  TLocalCall = function(ClassID: ClassID; Base: Pointer): PIClass; cdecl;
var
  Call: TLocalCall;
begin
...
function MakeClass(ClassID: ClassID; SuperClassID: ClassID; SuperClassPtr: PIClass; InstanceSize: LongWord; Flags: LongWord): PIClass;
type
  TLocalCall = function(ClassID: ClassID; SuperClassID: ClassID; SuperClassPtr: PIClass; InstanceSize: LongWord; Flags: LongWord; Base: Pointer): PIClass; cdecl;
var
  Call: TLocalCall;
begin
...
function ResetMenuStrip(Window: PWindow; Menu: PMenu): LongBool;
type
  TLocalCall = function(Window: PWindow; Menu: PMenu; Base: Pointer): LongBool; cdecl;
var
  Call: TLocalCall;
...
function FreeClass(IClass: PIClass): LongBool;
type
  TLocalCall = function(IClass: PIClass; Base: Pointer): LongBool; cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(IntuitionBase, 119));
  Result := Call(IClass, IntuitionBase);
end;

function AllocScreenBuffer(Screen: PScreen; Bitmap: PBitMap; Flags: LongWord): PScreenBuffer;
type
  TLocalCall = function(Screen: PScreen; Bitmap: PBitMap; Flags: LongWord; Base: Pointer): PScreenBuffer; cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(IntuitionBase, 128));
  Result := Call(Screen, Bitmap, Flags, IntuitionBase);
end;

procedure FreeScreenBuffer(Screen: PScreen; ScreenBuffer: PScreenBuffer);
type
  TLocalCall = procedure(Screen: PScreen; ScreenBuffer: PScreenBuffer; Base: Pointer); cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(IntuitionBase, 129));
  Call(Screen, ScreenBuffer, IntuitionBase);
end;

function ChangeScreenBuffer(Screen: PScreen; ScreenBuffer: PScreenBuffer): LongWord;
type
  TLocalCall = function(Screen: PScreen; ScreenBuffer: PScreenBuffer; Base: Pointer): LongWord; cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(IntuitionBase, 130));
  Result := Call(Screen, ScreenBuffer, IntuitionBase);
end;

procedure ScreenDepth(Screen: PScreen; Flags: LongWord; Reserved: APTR);
type
  TLocalCall = procedure(Screen: PScreen; Flags: LongWord; Reserved: APTR; Base: Pointer); cdecl;
var
  Call: TLocalCall;
begin
...
procedure ScrollWindowRaster(Win: PWindow; Dx: SmallInt; Dy: SmallInt; XMin: SmallInt; YMin: SmallInt; XMax: SmallInt; YMax: SmallInt);
type
  TLocalCall = procedure(Win: PWindow; Dx: SmallInt; Dy: SmallInt; XMin: SmallInt; YMin: SmallInt; XMax: SmallInt; YMax: SmallInt; Base: Pointer); cdecl;
var
  Call: TLocalCall;
begin
...
function DoGadgetMethodA(Gad: PGadget; Win: PWindow; Req: PRequester; Msg: TMsg): IPTR;
type
  TLocalCall = function(Gad: PGadget; Win: PWindow; Req: PRequester; Msg: TMsg; Base: Pointer): IPTR; cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(IntuitionBase, 135));
  Result := Call(Gad, Win, Req, Msg, IntuitionBase);
end;

procedure SetWindowPointerA(Win: PWindow; Taglist: PTagItem);
type
  TLocalCall = procedure(Win: PWindow; Taglist: PTagItem; Base: Pointer); cdecl;
var
  Call: TLocalCall;
begin
...
function TimedDisplayAlert(AlertNumber: LongWord; String_: PChar; Height: Word; Time: LongWord): LongBool;
type
  TLocalCall = function(AlertNumber: LongWord; String_: PChar; Height: Word; Time: LongWord; Base: Pointer): LongBool; cdecl;
var
  Call: TLocalCall;
begin
...
procedure HelpControl(Window: PWindow; Flags: LongWord);
type
  TLocalCall = procedure(Window: PWindow; Flags: LongWord; Base: Pointer); cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(IntuitionBase, 138));
  Call(Window, Flags, IntuitionBase);
end;
...
function DoNotify(Cl: PIClass; O: PObject_; Ic: Pointer; Msg: TopUpdate): Pointer;
type
  TLocalCall = function(Cl: PIClass; O: PObject_; Ic: Pointer; Msg: TopUpdate; Base: Pointer): Pointer; cdecl;
var
  Call: TLocalCall;
begin
...
function StartScreenNotifyTagList(Tags: PTagItem): IPTR;
type
  TLocalCall = function(Tags: PTagItem; Base: Pointer): IPTR; cdecl;
var
  Call: TLocalCall;
begin
...
function EndScreenNotify(Notify: IPTR): LongBool;
type
  TLocalCall = function(Notify: IPTR; Base: Pointer): LongBool; cdecl;
var
  Call: TLocalCall;
begin
...
function GetMonitorList(Tags: PTagItem): PPObject_;
type
  TLocalCall = function(Tags: PTagItem; Base: Pointer): PPObject_; cdecl;
var
  Call: TLocalCall;
begin
...
procedure FreeMonitorList(Obj: PPObject_);
type
  TLocalCall = procedure(Obj: PPObject_; Base: Pointer); cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(IntuitionBase, 164));

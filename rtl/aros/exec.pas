...
procedure AddIntServer(IntNumber: ULONG; Interrupt_: PInterrupt);
procedure AddLibrary(Library_: PLibrary);
procedure AddMemHandler(MemHandler: PInterrupt);
procedure AddMemList(Size: ULONG; Attributes: ULONG; Pri: LongInt; Base: APTR; const Name: STRPTR);
procedure AddPort(Port: PMsgPort);
function AddResetCallback(ResetCallback: PInterrupt): LongBool;
procedure AddResource(Resource: APTR);
procedure AddSemaphore(SigSem: PSignalSemaphore);
procedure AddTail(List: PList; Node: PNode);
function AddTask(Task: PTask; const InitialPC: APTR; const FinalPC: APTR): PTask; deprecated;
procedure Alert(AlertNum: ULONG);
function AllocAbs(ByteSize: ULONG; Location: APTR): APTR;
function Allocate(FreeList: PMemHeader; ByteSize: ULONG): PMemHeader;
function AllocEntry(Entry: PMemList): PMemList;
function AllocMem(ByteSize: ULONG; Requirements: ULONG): APTR;
function AllocPooled(PoolHeader: APTR; MemSize: ULONG): APTR;
function AllocSignal(SignalNum: LongInt): ShortInt;
function AllocTrap(TrapNum: LongInt): LongInt;
function AllocVec(ByteSize: ULONG; Requirements: ULONG): APTR;
function AllocVecPooled(Pool: APTR; Size: ULONG): APTR;
function AttemptSemaphore(SigSem: PSignalSemaphore): ULONG;
function AttemptSemaphoreShared(SigSem: PSignalSemaphore): ULONG;
function AvailMem(Requirements: ULONG): ULONG;
function AVL_AddNode(Root: PPAVLNode; Node: PAVLNode; Func: PAVLNODECOMP): PAVLNode;
function AVL_FindFirstNode(Root: PAVLNode): PAVLNode;
function AVL_FindLastNode(Root: PAVLNode): PAVLNode;
function AVL_FindNode(Root: PPAVLNode; Key: AVLKey; Func: PAVLNODECOMP): PAVLNode;
function AVL_FindPrevNodeByAddress(Node: PAVLNode): PAVLNode;
function AVL_FindPrevNodeByKey(Node: PAVLNode; Key: AVLKey): PAVLNode;
function AVL_FindNextNodeByAddress(Node: PAVLNode): PAVLNode;
function AVL_FindNextNodeByKey(Node: PAVLNode; Key: AVLKey): PAVLNode;
function AVL_RemNodeByAddress(Root: PPAVLNode; Node: PAVLNode): PAVLNode;
function AVL_RemNodeByKey(Root: PPAVLNode; Key: AVLKey; Func: PAVLNODECOMP): PAVLNode;
procedure CacheClearE(Address: APTR; Length: ULONG; Caches: ULONG);
procedure CacheClearU;
function CacheControl(CacheBits: ULONG; CacheMask: ULONG): ULONG;
procedure CachePostDMA(const Address: APTR; var Length: ULONG; Flags: ULONG);
function CachePreDMA(const Address: APTR; var Length: ULONG; Flags: ULONG): APTR;
procedure Cause(Interrupt_: PInterrupt);
function CheckIO(IORequest: PIORequest): PIORequest;
procedure ChildFree(Tid: ULONG);
function ChildOrphan(Tid: ULONG): ULONG;
function ChildStatus(Tid: ULONG): ULONG;
function ChildWait(Tid: ULONG): IPTR;
procedure CloseDevice(IORequest: PIORequest);
procedure CloseLibrary(Library_: PLibrary);
procedure ColdReboot;
procedure CopyMem(const Source: APTR; Dest: APTR; Size: ULONG);
procedure CopyMemQuick(const Source: APTR; Dest: APTR; Size: ULONG);
function CreateIORequest(const IOReplyPort: PMsgPort; Size: ULONG): APTR;
function CreateMsgPort: PMsgPort;
function CreatePool(Requirements: ULONG; PuddleSize: ULONG; ThreshSize: ULONG): APTR;
procedure Deallocate(FreeList: PMemHeader; MemoryBlock: APTR; ByteSize: ULONG);
procedure Debug(Flags: ULONG);
procedure DeleteIORequest(IORequest: APTR);
procedure DeleteMsgPort(Port: PMsgPort);
procedure DeletePool(PoolHeader: APTR);
procedure Disable;
procedure Dispatch;
function DoIO(IORequest: PIORequest): LongInt;
procedure Enable;
...
function FindSemaphore(const SigSem: STRPTR): PSignalSemaphore;
function FindTask(const Name: STRPTR): PTask;
procedure Forbid;
procedure FreeEntry(Entry: PMemList);
procedure FreePooled(PoolHeader: APTR; Memory: APTR; MemSize: ULONG);
procedure FreeSignal(SignalNum: LongInt);
procedure FreeTrap(TrapNum: LongInt);
procedure FreeVec(MemoryBlock: APTR);
procedure FreeVecPooled(Pool: APTR; Memory: APTR);
function GetCC: Word;
function GetMsg(Port: PMsgPort): PMessage;
procedure InitCode(StartClass: ULONG; Version: ULONG);
function InitResident(const Resident_: PResident; SegList: ULONG): PResident;
procedure InitSemaphore(SigSem: PSignalSemaphore);
procedure InitStruct(const InitTable: APTR; Memory: APTR; Size: ULONG);
procedure MakeFunctions(const Target: APTR; const FunctionArray: CONST_APTR; const FuncDispBase: CONST_APTR);
function MakeLibrary(const FuncInit: APTR; const StructInit: APTR; LibInit: TProcedure; DataSize: ULONG; SegList: ULONG): PLibrary;
function NewAddTask(Task: PTask; InitialPC: APTR; FinalPC: APTR; TagList: PTagItem): APTR;
function NewAddTaskA(TagList: PTagItem): APTR;
function NewAllocEntry(Entry: PMemList; var Return_Entry: PMemList; var Return_Flags: ULONG): LongBool;
function NewStackSwap(NewStack: PStackSwapStruct; Function_: APTR; Args: PStackSwapArgs): IPTR;
function ObtainQuickVector(InterruptCode: APTR): ULONG;
...
function OldOpenLibrary(const LibName: STRPTR): PLibrary; deprecated;
function OpenDevice(const DevName: STRPTR; UnitNumber: ULONG; IORequest: PIORequest; Flags: ULONG): LongInt;
function OpenLibrary(const LibName: STRPTR; Version: ULONG): PLibrary;
function OpenResource(const ResName: STRPTR): APTR;
procedure Permit;
function PrepareContext(Task: PTask; EntryPoint: APTR; FallBack: APTR; TagList: PTagItem): LongBool;
function Procure(SigSem: PSignalSemaphore; BidMsg: PSemaphoreMessage): ULONG;
procedure PutMsg(Port: PMsgPort; Message: PMessage);
function RawDoFmt(const FormatString: STRPTR; const DataStream: APTR; PutChProc: TProcedure; PutChData: APTR): APTR;
procedure RawIOInit;
function RawMayGetChar: LongInt;
procedure RawMayPutChar(Cha: Byte);
function ReadGayle: ULONG;
...
procedure RemIntServer(IntNumber: ULONG; Interrupt_: PInterrupt);
procedure RemLibrary(Library_: PLibrary);
procedure RemMemHandler(MemHandler: PInterrupt);
procedure Remove(Node: PNode);
procedure RemPort(Port: PMsgPort);
procedure RemResetCallback(ResetCallback: PInterrupt);
...
procedure Reschedule(Task: PTask);
procedure SendIO(IORequest: PIORequest);
function SetExcept(NewSignals: ULONG; SignalSet: ULONG): ULONG;
function SetFunction(Library_: PLibrary; FuncOffset: LongInt; NewFunction: TProcedure): APTR;
...
function ShutdownA(Action: ULONG): ULONG;
procedure Signal(Task: PTask; SignalSet: ULONG);
procedure StackSwap(NewStack: PStackSwapStruct); deprecated;
procedure SumKickData;
procedure SumLibrary(Library_: PLibrary);
function SuperState: APTR;
function Supervisor(UserFunction: TProcedure): ULONG;
procedure Switch;
function TaggedOpenLibrary(Tag: LongInt): APTR;
function TypeOfMem(const Address: APTR): ULONG;
procedure UserState(SysStack: APTR);
procedure Vacate(SigSem: PSignalSemaphore; BidMsg: PSemaphoreMessage);
function VNewRawDoFmt(const FormatString: STRPTR; PutChProc: TProcedure; PutChData: APTR; VaListStream: PChar): STRPTR;
function Wait(SignalSet: ULONG): ULONG;
function WaitIO(IORequest: PIORequest): LongInt;
...
procedure AddIntServer(IntNumber: ULONG; Interrupt_: pInterrupt);
type
  TLocalCall = procedure(IntNumber: ULONG; Interrupt_: PInterrupt; Base: Pointer); cdecl;
var
  Call: TLocalCall;
begin
...
procedure AddLibrary(Library_: PLibrary);
type
  TLocalCall = procedure(Library_: PLibrary; Base: Pointer); cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(AOS_ExecBase, 66));
  Call(Library_, AOS_ExecBase);
end;

procedure AddMemHandler(MemHandler: PInterrupt);
type
  TLocalCall = procedure(MemHandler: PInterrupt; Base: Pointer); cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(AOS_ExecBase, 129));
  Call(MemHandler, AOS_ExecBase);
end;

procedure AddMemList(Size: ULONG; Attributes: ULONG; Pri: LongInt; Base: APTR; const Name: STRPTR);
type
  TLocalCall = procedure(Size: ULONG; Attributes: ULONG; Pri: LongInt; Base: APTR; const Name: STRPTR; LibBase: Pointer); cdecl;
var
  Call: TLocalCall;
begin
...
function AddResetCallback(ResetCallback: PInterrupt): LongBool;
type
  TLocalCall = function(ResetCallback: PInterrupt; Base: Pointer): LongBool; cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(AOS_ExecBase, 167));
  AddResetCallback := Call(ResetCallback, AOS_ExecBase);
end;

procedure AddResource(Resource: APTR);
type
  TLocalCall = procedure(Resource: APTR; LibBase: Pointer); cdecl;
var
  Call: TLocalCall;
begin
...
function AddTask(Task: PTask; const InitialPC: APTR; const FinalPC: APTR): PTask;
type
  TLocalCall = function(task: PTask; const InitialPC: APTR; const FinalPC: APTR; LibBase: Pointer): PTask; cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(AOS_ExecBase, 47));
  AddTask := Call(Task, InitialPC, FinalPC, AOS_ExecBase);
end;
...
function Allocate(FreeList: PMemHeader; ByteSize: ULONG): PMemHeader;
type
  TLocalCall = function(FreeList: PMemHeader; ByteSize: ULONG; LibBase: Pointer): PMemHeader; cdecl;
var
  Call: TLocalCall;
begin
...
function AllocMem(ByteSize: ULONG; Requirements: ULONG): APTR;
type
  TLocalCall = function(byteSize: ULONG; requirements: ULONG; LibBase: APTR): Pointer; cdecl;
var
  Call: TLocalCall;
begin
...
function AllocPooled(PoolHeader: APTR; MemSize: ULONG): APTR;
type
  TLocalCall = function(PoolHeader: APTR; MemSize: ULONG; LibBase: Pointer): Pointer; cdecl;
var
  Call: TLocalCall;
begin
...
function AllocVec(ByteSize: ULONG; Requirements: ULONG): APTR;
type
  TLocalCall = function(ByteSize: ULONG; Requirements: ULONG; LibBase: Pointer): APTR; cdecl;
var
  Call: TLocalCall;
begin
...
function AllocVecPooled(Pool: APTR; Size: ULONG): APTR;
type
  TLocalCall = function(Pool: APTR; Size: ULONG; LibBase: Pointer): APTR; cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(AOS_ExecBase, 149));
  AllocVecPooled := Call(Pool, Size, AOS_ExecBase);
end;
...
function AVL_AddNode(Root: PPAVLNode; Node: PAVLNode; Func: PAVLNODECOMP): PAVLNode;
type
  TLocalCall = function(Root: PPAVLNode; Node: PAVLNode; Func: PAVLNODECOMP; LibBase: Pointer): PAVLNode; cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(AOS_ExecBase, 139));
  AVL_AddNode := Call(Root, Node, Func, AOS_ExecBase);
end;

function AVL_FindLastNode(Root: PAVLNode): PAVLNode;
type
  TLocalCall = function(Root: PAVLNode; LibBase: Pointer): PAVLNode; cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(AOS_ExecBase, 148));
  AVL_FindLastNode := Call(Root, AOS_ExecBase);
end;
...
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(AOS_ExecBase, 147));
  AVL_FindFirstNode := Call(Root, AOS_ExecBase);
end;

function AVL_FindNode(Root: PPAVLNode; Key: AVLKey; Func: PAVLNODECOMP): PAVLNode;
type
  TLocalCall = function(Root: PPAVLNode; Key: AVLKey; Func: PAVLNODECOMP; LibBase: Pointer): PAVLNode; cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(AOS_ExecBase, 142));
  AVL_FindNode := Call(Root, Key, Func, AOS_ExecBase);
end;

function AVL_FindPrevNodeByAddress(Node: PAVLNode): PAVLNode;
type
  TLocalCall = function(Node: PAVLNode; LibBase: Pointer): PAVLNode; cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(AOS_ExecBase, 143));
  AVL_FindPrevNodeByAddress := Call(Node, AOS_ExecBase);
end;

function AVL_FindPrevNodeByKey(Node: PAVLNode; Key: AVLKey): PAVLNode;
type
  TLocalCall = function(Node: PAVLNode; Key: AVLKey; LibBase: Pointer): PAVLNode; cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(AOS_ExecBase, 144));
  AVL_FindPrevNodeByKey := Call(Node, Key, AOS_ExecBase);
end;
...
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(AOS_ExecBase, 145));
  AVL_FindNextNodeByAddress := Call(Node, AOS_ExecBase);
end;
...
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(AOS_ExecBase, 146));
  AVL_FindNextNodeByKey := Call(Node, Key, AOS_ExecBase);
end;

function AVL_RemNodeByAddress(Root: PPAVLNode; Node: PAVLNode): PAVLNode;
type
  TLocalCall = function(Root: PPAVLNode; Node: PAVLNode; LibBase: Pointer): PAVLNode; cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(AOS_ExecBase, 140));
  AVL_RemNodeByAddress := Call(Root, Node, AOS_ExecBase);
end;
...
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(AOS_ExecBase, 141));
  AVL_RemNodeByKey := Call(Root, Key, Func, AOS_ExecBase);
end;

procedure CacheClearE(Address: APTR; Length: ULONG; Caches: ULONG);
type
  TLocalCall = procedure(Address: APTR; Length: ULONG; Caches: ULONG; LibBase: Pointer); cdecl;
var
  Call: TLocalCall;
begin
...
procedure ChildFree(Tid: ULONG);
type
  TLocalCall = procedure(Tid: ULONG; LibBase: Pointer); cdecl;
var
  Call: TLocalCall;
begin
...
function ChildOrphan(tid: ULONG): ULONG;
type
  TLocalCall = function(tid: ULONG; LibBase: Pointer): ULONG; cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(AOS_ExecBase, 124));
  ChildOrphan := Call(tid, AOS_ExecBase);
end;
...
begin
  ...
  ChildStatus := Call(tid, AOS_ExecBase);
end;

function ChildWait(Tid: ULONG): IPTR;
type
  TLocalCall = function(Tid: ULONG; LibBase: Pointer): IPTR; cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(AOS_ExecBase, 126));
  ChildWait := Call(Tid, AOS_ExecBase);
end;
...
procedure CloseLibrary(Library_: PLibrary);
type
  TLocalCall = procedure(Library_: PLibrary; LibBase: Pointer); cdecl;
var
  Call: TLocalCall;
begin
...
procedure CopyMem(const Source: APTR; Dest: APTR; size: ULONG);
type
  TLocalCall = procedure(const Source: APTR; Dest: APTR; Size: ULONG; LibBase: Pointer); cdecl;
var
  Call: TLocalCall;
begin
...
function CreateIORequest(const IOReplyPort: PMsgPort; Size: ULONG): APTR;
type
  TLocalCall = function(const IOReplyPort: pMsgPort; Size: ULONG; LibBase: Pointer): APTR; cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(AOS_ExecBase, 109));
  CreateIORequest := Call(IOReplyPort, Size, AOS_ExecBase);
end;
...
Pointer;
type
  TLocalCall = function(Requirements: ULONG; PuddleSize: ULONG; ThreshSize: ULONG; LibBase: Pointer): APTR; cdecl;
var
  Call: TLocalCall;
begin
...
procedure Deallocate(FreeList: PMemHeader; MemoryBlock: APTR; ByteSize: ULONG);
type
  TLocalCall = procedure(FreeList: PMemHeader; MemoryBlock: APTR; ByteSize: ULONG; LibBase: Pointer); cdecl;
var
  Call: TLocalCall;
begin
...
procedure DeletePool(PoolHeader: APTR);
type
  TLocalCall = procedure(PoolHeader: APTR; LibBase: Pointer); cdecl;
var
  Call: TLocalCall;
begin
...
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(AOS_ExecBase, 10));
  Call(AOS_ExecBase);
end;

function DoIO(IORequest: PIORequest): LongInt;
type
  TLocalCall = function(IORequest: PIORequest; LibBase: Pointer): LongInt; cdecl;
var
  Call: TLocalCall;
begin
...
procedure ExecFreeMem(MemoryBlock: APTR; ByteSize: ULONG);
type
  TLocalCall = procedure(MemoryBlock: APTR; ByteSize: ULONG; LibBase: Pointer); cdecl;
var
  Call: TLocalCall;
begin
...
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(AOS_ExecBase, 11));
  Call(AOS_ExecBase);
end;
...
function FindTask(const Name: STRPTR): pTask;
type
  TLocalCall = function(const name: STRPTR; LibBase: Pointer): pTask; cdecl;
var
  Call: TLocalCall;
begin
...
procedure FreePooled(PoolHeader: APTR; Memory: APTR; memSize: ULONG);
type
  TLocalCall = procedure(PoolHeader: APTR; Memory: APTR; memSize: ULONG; LibBase: Pointer); cdecl;
var
  Call: TLocalCall;
begin
...
procedure FreeVec(MemoryBlock: APTR);
type
  TLocalCall = procedure(MemoryBlock: APTR; LibBase: Pointer); cdecl;
var
  Call: TLocalCall;
begin
...
procedure FreeVecPooled(Pool: APTR; Memory: APTR);
type
  TLocalCall = procedure(Pool: APTR; Memory: APTR; LibBase: Pointer); cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(AOS_ExecBase, 150));
  Call(Pool, Memory, AOS_ExecBase);
end;

function GetCC: Word;
type
  TLocalCall = function(LibBase: Pointer): Word; cdecl;
var
  Call: TLocalCall;
begin
...
function InitResident(const Resident_: PResident; SegList: ULONG): PResident;
type
  TLocalCall = function(const Resident_: PResident; SegList: ULONG; LibBase: Pointer): PResident; cdecl;
var
  Call: TLocalCall;
begin
...
procedure InitStruct(const InitTable: APTR; Memory: APTR; Size: ULONG);
type
  TLocalCall = procedure(const InitTable: APTR; Memory: APTR; Size: ULONG; LibBase: Pointer); cdecl;
var
  Call: TLocalCall;
begin
...
procedure Makefunctions(const Target: APTR; const FunctionArray: APTR; const FuncDispBase :APTR);
type
  TLocalCall = procedure(const Target: APTR; const FunctionArray: APTR; const FuncDispBase :APTR; LibBase: Pointer); cdecl;
var
  Call: TLocalCall;
begin
...
function MakeLibrary(const FuncInit: APTR; const StructInit: APTR; LibInit: TProcedure; DataSize: ULONG; SegList: ULONG): PLibrary;
type
  TLocalCall = function(const FuncInit: APTR; const StructInit: APTR; LibInit: TProcedure; DataSize: ULONG; SegList: ULONG; LibBase: Pointer): PLibrary; cdecl;
var
  Call: TLocalCall;
begin
...
function NewAddTask(Task: PTask; InitialPC: APTR; FinalPC: APTR; TagList: PTagItem): APTR;
type
  TLocalCall = function(Task: PTask; InitialPC: APTR; FinalPC: APTR; TagList: PTagItem; LibBase: Pointer): APTR; cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(AOS_ExecBase, 152));
  NewAddTask := Call(Task, InitialPC, FinalPC, TagList, AOS_ExecBase);
end;

function NewAddTaskA(TagList: PTagItem): APTR;
type
  TLocalCall = function(TagList: PTagItem; LibBase: Pointer): APTR; cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(AOS_ExecBase, 153));
  NewAddTaskA := Call(TagList, AOS_ExecBase);
end;

function NewAllocEntry(Entry: PMemList; var Return_Entry: PMemList; var Return_Flags: ULONG): LongBool;
type
  TLocalCall = function(Entry: PMemList; var Return_Entry: PMemList; var Return_Flags: ULONG; LibBase: Pointer): LongBool; cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(AOS_ExecBase, 151));
  NewAllocEntry := Call(Entry, Return_Entry, Return_Flags, AOS_ExecBase);
end;

function NewStackSwap(NewStack: PStackSwapStruct; Function_: APTR; Args: PStackSwapArgs): IPTR;
type
  TLocalCall = function(NewStack: PStackSwapStruct; Function_: APTR; Args: PStackSwapArgs; LibBase: Pointer): IPTR; cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(AOS_ExecBase, 134));
  NewStackSwap := Call(NewStack, Function_, Args, AOS_ExecBase);
end;

function ObtainQuickVector(InterruptCode: APTR): ULONG;
type
  TLocalCall = function(InterruptCode: APTR; LibBase: Pointer): ULONG; cdecl;
var
  Call: TLocalCall;
begin
...
function OldOpenLibrary(const LibName: STRPTR): PLibrary;
type
  TLocalCall = function(const libName: STRPTR; LibBase: Pointer): PLibrary; cdecl;
var
  Call: TLocalCall;
begin
...
function OpenDevice(const DevName: STRPTR; UnitNumber: ULONG; IORequest: PIORequest; Flags: ULONG): LongInt;
type
  TLocalCall = function(const devName: STRPTR; UnitNumber: ULONG; IORequest: PIORequest; Flags: ULONG; LibBase: Pointer): LongInt; cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(AOS_ExecBase, 74));
  OpenDevice := Call(DevName, UnitNumber, IORequest, Flags, AOS_ExecBase);
end;

function OpenLibrary(const LibName: STRPTR; Version: ULONG): PLibrary;
type
  TLocalCall = function(const LibName: STRPTR; Version: ULONG; LibBase: Pointer): PLibrary; cdecl;
var
  Call: TLocalCall;
begin
...
function OpenResource(const ResName: STRPTR): Pointer;
type
  TLocalCall = function(const ResName: STRPTR; LibBase: Pointer): Pointer; cdecl;
var
  Call: TLocalCall;
begin
...
function PrepareContext(Task: PTask; EntryPoint: APTR; FallBack: APTR; TagList: PTagItem): LongBool;
type
  TLocalCall = function(Task: PTask; EntryPoint: APTR; FallBack: APTR; TagList: PTagItem; LibBase: Pointer): LongBool; cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(AOS_ExecBase, 6));
  PrepareContext := Call(Task, EntryPoint, FallBack, TagList, AOS_ExecBase);
end;

function Procure(SigSem: PSignalSemaphore; BidMsg: PSemaphoreMessage): ULONG;
type
  TLocalCall = function(SigSem: PSignalSemaphore; BidMsg: PSemaphoreMessage; LibBase: Pointer): ULONG; cdecl;
var
  Call: TLocalCall;
begin
...
function RawDoFmt(const FormatString: STRPTR; const DataStream: APTR; PutChProc: TProcedure; PutChData: APTR): pointer;
type
  TLocalCall = function(const FormatString: STRPTR;const DataStream: APTR; PutChProc: TProcedure; PutChData: APTR; LibBase: Pointer): pointer; cdecl;
var
  Call: TLocalCall;
begin
...
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(AOS_ExecBase, 84));
  Call(AOS_ExecBase);
end;
...
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(AOS_ExecBase, 85));
  RawMayGetChar := Call(AOS_ExecBase);
end;

procedure RawMayPutChar(Cha: Byte);
type
  TLocalCall = procedure(Cha: Byte; LibBase: Pointer); cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(AOS_ExecBase, 86));
  Call(Cha, AOS_ExecBase);
end;
...
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(AOS_ExecBase, 136));
  ReadGayle := Call(AOS_ExecBase);
end;
...
procedure RemIntServer(IntNumber: ULONG; Interrupt_: PInterrupt);
type
  TLocalCall = procedure(IntNumber: ULONG; Interrupt_: PInterrupt; LibBase: Pointer); cdecl;
var
  Call: TLocalCall;
begin
...
procedure RemMemHandler(MemHandler: PInterrupt);
type
  TLocalCall = procedure(MemHandler: PInterrupt; LibBase: Pointer); cdecl;
var
  Call: TLocalCall;
begin
...
procedure RemResetCallback(ResetCallback: PInterrupt);
type
  TLocalCall = procedure(ResetCallback: PInterrupt; LibBase: Pointer); cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(AOS_ExecBase, 168));
  Call(ResetCallback, AOS_ExecBase);
end;
...
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(AOS_ExecBase, 8));
  Call(Task, AOS_ExecBase);
end;
...
function Setfunction(Library_: PLibrary; FuncOffset: LongInt; NewFunction: TProcedure): APTR;
type
  TLocalCall = function(Library_: PLibrary; funcOffset: LongInt; NewFunction: TProcedure; LibBase: Pointer): APTR; cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(AOS_ExecBase, 70));
  Setfunction := Call(Library_, FuncOffset, Newfunction, AOS_ExecBase);
end;
...
function ShutdownA(Action: ULONG): ULONG;
type
  TLocalCall = function(Action: ULONG; LibBase: Pointer): ULONG; cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(AOS_ExecBase, 173));
  ShutdownA := Call(Action, AOS_ExecBase);
end;
...
function SuperState: APTR;
type
  TLocalCall = function(LibBase: Pointer): APTR; cdecl;
var
  Call: TLocalCall;
begin
...
function TaggedOpenLibrary(Tag: LongInt): APTR;
type
  TLocalCall = function(Tag: LongInt; LibBase: Pointer): APTR; cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(AOS_ExecBase, 135));
  TaggedOpenLibrary := Call(Tag, AOS_ExecBase);
end;

function TypeOfMem(const Address: APTR): ULONG;
type
  TLocalCall = function(const Address: APTR; LibBase: Pointer): ULONG; cdecl;
var
  Call: TLocalCall;
begin
...
procedure UserState(SysStack: APTR);
type
  TLocalCall = procedure(SysStack: APTR; LibBase: Pointer); cdecl;
var
  Call: TLocalCall;
begin
...
function VNewRawDoFmt(const FormatString: STRPTR; PutChProc: TProcedure; PutChData: APTR; VaListStream: PChar): STRPTR;
type
  TLocalCall = function(const FormatString: STRPTR; PutChProc: TProcedure; PutChData: APTR; VaListStream: PChar; LibBase: Pointer): STRPTR; cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(AOS_ExecBase, 137));
  VNewRawDoFmt := Call(FormatString, PutChProc, PutChData, VaListStream, AOS_ExecBase);
end;

...
{ GLOC }
AVR32_GLOC_ADDRESS =        $FFFF6C00;
AVR32_GLOC_LUTS =           2;
{ GPIO }
AVR32_GPIO_ADDRESS =        $FFFF2C00;
AVR32_GPIO_PORT_LENGTH =    2;
{ HMATRIX }
AVR32_HMATRIXB_ADDRESS =    $FFFE0400;
{ PDCA }
...
CAT_atbase:        LongInt absolute AVR32_CAT_ADDRESS+$006c;
CAT_atcurr:        LongInt absolute AVR32_CAT_ADDRESS+$0070;
CAT_acshi0:        LongInt absolute AVR32_CAT_ADDRESS+$0080;
CAT_acshi1:        LongInt absolute AVR32_CAT_ADDRESS+$0084;
CAT_acshi2:        LongInt absolute AVR32_CAT_ADDRESS+$0088;
CAT_acshi3:        LongInt absolute AVR32_CAT_ADDRESS+$008c;
CAT_acshi4:        LongInt absolute AVR32_CAT_ADDRESS+$0090;
CAT_acshi5:        LongInt absolute AVR32_CAT_ADDRESS+$0094;
CAT_acshi6:        LongInt absolute AVR32_CAT_ADDRESS+$0098;
CAT_acshi7:        LongInt absolute AVR32_CAT_ADDRESS+$009c;
...
{ GLOC }
type
Tavr32_gloc_lut_t = packed record
    cr,truth: LongInt;
end;

var
    lut: array[0..(AVR32_GLOC_LUTS-1)] of LongInt absolute AVR32_GLOC_ADDRESS;
    parameter:      LongInt absolute AVR32_GLOC_ADDRESS+$0038;
    version:        LongInt absolute AVR32_GLOC_ADDRESS+$003c;
{ GPIO }
type

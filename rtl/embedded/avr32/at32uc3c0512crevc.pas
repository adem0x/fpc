...
AVR32_EBI_CS0_ADDRESS =     $C0000000;
AVR32_EBI_CS2_ADDRESS =     $C8000000;
AVR32_EBI_CS3_ADDRESS =     $CC000000;
AVR32_EBI_CS1_0_ADDRESS =   $D0000000;
AVR32_EBI_CS1_1_ADDRESS =   $D4000000;
...
(* SDRAMC *)
AVR32_SDRAMC_ADDRESS =      $FFFE2C00;
(* SMC *)
AVR32_SMC_ADDRESS =         $FFFE2800;
(* SPI0 *)
...
(* SDRAMC *)
SDRAMC_mr:        LongInt absolute AVR32_SDRAMC_ADDRESS;
SDRAMC_tr:        LongInt absolute AVR32_SDRAMC_ADDRESS+$0004;
SDRAMC_cr:        LongInt absolute AVR32_SDRAMC_ADDRESS+$0008;
SDRAMC_hsr:       LongInt absolute AVR32_SDRAMC_ADDRESS+$000c;
SDRAMC_lpr:       LongInt absolute AVR32_SDRAMC_ADDRESS+$0010;
SDRAMC_ier:       LongInt absolute AVR32_SDRAMC_ADDRESS+$0014;
SDRAMC_idr:       LongInt absolute AVR32_SDRAMC_ADDRESS+$0018;
SDRAMC_imr:       LongInt absolute AVR32_SDRAMC_ADDRESS+$001c;
SDRAMC_isr:       LongInt absolute AVR32_SDRAMC_ADDRESS+$0020;
SDRAMC_mdr:       LongInt absolute AVR32_SDRAMC_ADDRESS+$0024;
SDRAMC_version:   LongInt absolute AVR32_SDRAMC_ADDRESS+$00fc;
(* SMC *)
type
Tavr32_smc_cs_t = packed record
   setup,pulse,cycle,mode: LongInt;
end;

var
SMC_cs:      array[0..5] of Tavr32_smc_cs_t absolute AVR32_SMC_ADDRESS;
SMC_version: LongInt absolute AVR32_SMC_ADDRESS+$00fc;
(* SPI0 *)

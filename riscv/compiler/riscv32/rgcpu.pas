{
    Copyright (c) 1998-2014 by Florian Klaempfl and David Zhang and Jeppe Johansen

    This unit implements the register allocator for RISC-V
...
implementation
    ...
    procedure trgcpu.do_spill_read(list:tasmlist;pos:tai;const spilltemp:treference;tempreg:tregister);
      var
        ...
        hreg     : tregister;
      begin
        if (spilltemp.offset>simm12hi) or (spilltemp.offset<simm12lo) then
          begin
            ...
            helplist.concat(taicpu.op_reg_const(A_LUI,hreg,spilltemp.offset shr 11));
            helplist.concat(taicpu.op_reg_reg_const(A_ORI,hreg,hreg,spilltemp.offset and $7FF));
    ...
    function trgcpu.do_spill_replace(list:TAsmList;instr:taicpu;orgreg:tsuperregister;const spilltemp:treference):boolean;
      begin
        ...
        if (instr.opcode<>A_MOVE) or (spilltemp.offset>simm12hi) or (spilltemp.offset<simm12lo) then
          exit;
        if (instr.ops<>2) or

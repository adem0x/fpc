{
    ...
    Includes ELF-related code specific to RISC-V
...
unit cpuelf;
  ...
  implementation
    ...
    type
      TElfExeOutputRISCV=class(TElfExeOutput)
      private
  ...
  ****************************************************************************}
    ...
    function elf_riscv_encodereloc(objrel:TObjRelocation):byte;
      begin
        case objrel.typ of
          RELOC_NONE:
            result:=R_MIPS_NONE;
    ...
    function elf_riscv_relocname(reltyp:byte):string;
      begin
        result:='TODO';
      end;


    procedure elf_riscv_loadreloc(objrel:TObjRelocation);
      begin
      end;


    function elf_riscv_loadsection(objinput:TElfObjInput;objdata:TObjData;const shdr:TElfsechdr;shindex:longint):boolean;
      var
        ri: TElfReginfo;
      begin
        result:=false;
  ...
  *****************************************************************************}
    ...
    constructor TElfExeOutputRISCV.Create;
      begin
        inherited Create;
    ...
    destructor TElfExeOutputRISCV.Destroy;
      begin
    ...
    procedure TElfExeOutputRISCV.CreateGOTSection;
      begin
    ...
    procedure TElfExeOutputRISCV.CreatePLT;
      begin
    ...
    procedure TElfExeOutputRISCV.WriteTargetDynamicTags;
      begin
    ...
    procedure TElfExeOutputRISCV.WritePLTEntry(exesym: TExeSymbol);
      begin

      end;


    function TElfExeOutputRISCV.AllocGOTSlot(objsym:TObjSymbol):boolean;
      var
        exesym: TExeSymbol;
      begin
    ...
    procedure TElfExeOutputRISCV.PrepareGOT;
      var
        i: longint;
        exesym: TExeSymbol;
        exesec: TExeSection;
    ...
    procedure TElfExeOutputRISCV.Do_Mempos;
      var
        i:longint;
    ...
    procedure TElfExeOutputRISCV.FixupRelocations;
      begin
        if dynrelsize>0 then
    ...
    procedure TElfExeOutputRISCV.MaybeWriteGOTEntry(relocval:aint;objsym:TObjSymbol);
      var
        gotoff:aword;
      begin
    ...
    procedure TElfExeOutputRISCV.MaybeWriteTLSIEGotEntry(relocval:aint;objsym:TObjSymbol);
      var
        gotoff,tmp:aword;
      begin
        gotoff:=objsym.exesymbol.gotoffset;
    ...
    procedure TElfExeOutputRISCV.CreatePICStub(objsym:TObjSymbol);
      var
    ...
    procedure TElfExeOutputRISCV.GOTRelocPass1(objsec:TObjSection;var idx:longint);
      var
    ...
    procedure TElfExeOutputRISCV.DoRelocationFixup(objsec:TObjSection);
      var
        i,zero:longint;
        objreloc: TObjRelocation;
        AHL_S,
...
initialization
  ...
  ElfExeOutputClass:=TElfExeOutputRISCV;

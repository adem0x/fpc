...
{$i fpcdefs.inc}
  ...
  interface
    ...
    type
      triscvinlinenode = class(tcgInlineNode)
  ...
  implementation
    ...
    procedure triscvinlinenode.load_fpu_location;
      begin
        secondpass(left);
    ...
    function triscvinlinenode.first_abs_real: tnode;
      begin
    ...
    function triscvinlinenode.first_sqr_real: tnode;
      begin
        if current_settings.fputype in [fpu_r32fd] then
          begin
            expectloc      := LOC_FPUREGISTER;
    ...
    function triscvinlinenode.first_sqrt_real: tnode;
      begin
        if current_settings.fputype in [fpu_r32fd] then
          begin
            expectloc    := LOC_FPUREGISTER;
    ...
    procedure triscvinlinenode.second_abs_real;
      begin
        {load_fpu_location;
    ...
    procedure triscvinlinenode.second_sqr_real;
      begin
        {load_fpu_location;
        case tfloatdef(left.resultdef).floattype of
          s32real:
    ...
    procedure triscvinlinenode.second_sqrt_real;
      begin
        {load_fpu_location;
        case tfloatdef(left.resultdef).floattype of
          s32real:
    ...
    procedure triscvinlinenode.second_get_frame;
      begin

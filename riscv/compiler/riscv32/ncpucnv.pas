...
{$i fpcdefs.inc}
  ...
  interface
    ...
    type
      triscvtypeconvnode = class(tcgtypeconvnode)
      protected
  ...
  implementation
    ...
    function triscvtypeconvnode.first_int_to_real: tnode;
      var
        fname: string[19];
      begin
    ...
    procedure triscvtypeconvnode.second_int_to_real;
      begin
        internalerror(2014110104);
      end;


    procedure triscvtypeconvnode.second_int_to_bool;
      var
...
begin
  ctypeconvnode := triscvtypeconvnode;
end.

...
implementation
    ...
    procedure read_exports;
      ...
      begin
         ...
         DefString:='';
         InternalProcName:='';
         current_scanner.consume(_EXPORTS);
         repeat
           hpname:='';
           options:=0;
           index:=0;
           if current_scanner.token=_ID then
             begin
                current_scanner.consume_sym_orgid(srsym,srsymtable,orgs);
                ...
                if (srsym.typ<>typesym) then
                  begin
                    ...
                    if current_scanner.try_to_consume(_INDEX) then
                     begin
                       pt:=comp_expr(true);
                    ...
                    if current_scanner.try_to_consume(_RESIDENT) then
                     begin

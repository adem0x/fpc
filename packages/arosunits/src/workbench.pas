...
{ v36 }
function UpdateWorkbench(const Name: STRPTR; Lock: BPTR; Action: LongInt): LongBool;
function QuoteWorkbench(StringNum: LongWord): LongBool; unimplemented;
function StartWorkbench(Flag: LongWord; Ptr: APTR): LongBool;
function AddAppWindowA(ID: LongWord; UserData: LongWord; Window: PWindow; MsgPort: PMsgPort; TagList: PTagItem): PAppWindow;
function RemoveAppWindow(AppWindow: PAppWindow): LongBool;
function AddAppIconA(ID: LongWord; UserData: LongWord; Text_: PChar; MsgPort: PMsgPort; Lock: BPTR; DiskObj: PDiskObject; TagList: PTagItem): PAppIcon;
function RemoveAppIcon(AppIcon: PAppIcon): LongBool;
function AddAppMenuItemA(ID: LongWord; UserData: LongWord; Text_: APTR; MsgPort: PMsgPort; TagList: PTagItem): PAppMenuItem;
function RemoveAppMenuItem(AppMenuItem: PAppMenuItem): LongBool;
{ v39 }
function WBConfig(Unk1: LongWord; Unk2: LongWord): LongBool; unimplemented;
function WBInfo(Lock: BPTR; const Name: STRPTR; Screen: PScreen): LongBool;
{ v44 }
function OpenWorkbenchObjectA(Name: STRPTR; Tags: PTagItem): LongBool;
function CloseWorkbenchObjectA(Name: STRPTR; Tags: PTagItem): LongBool; unimplemented;
function WorkbenchControlA(Name: STRPTR; Tags: PTagItem): LongBool;
function AddAppWindowDropZoneA(Aw: PAppWindow; ID: LongWord; UserData: LongWord; Tags: PTagItem): PAppWindowDropZone;
function RemoveAppWindowDropZone(Aw: PAppWindow; DropZone: PAppWindowDropZone): LongBool;
function ChangeWorkbenchSelectionA(Name: STRPTR; Hook: PHook; Tags: PTagItem): LongBool; unimplemented;
function MakeWorkbenchObjectVisibleA(Name: STRPTR; Tags: PTagItem): LongBool; unimplemented;
{ v45, AROS only ? }
function RegisterWorkbench(MessagePort: PMsgPort): LongBool;
function UnregisterWorkbench(MessagePort: PMsgPort): LongBool;
function UpdateWorkbenchObjectA(Name: STRPTR; Type_: LongInt; Tags: PTagItem): LongBool;
function SendAppWindowMessage(Win: PWindow; NumFiles: LongWord; Files: PPChar; Class_: Word; MouseX: SmallInt; MouseY: SmallInt; Seconds: LongWord; Micros: LongWord): LongBool;
function GetNextAppIcon(LastDiskObj: PDiskObject; Text_: PChar): PDiskObject;
...
function UpdateWorkbench(const Name: STRPTR; Lock: BPTR; Action: LongInt): LongBool;
type
  TLocalCall = function(const Name: STRPTR; Lock: BPTR; Action: LongInt; LibBase: Pointer): LongBool; cdecl;
Var
  Call: TLocalCall;
Begin
...
function QuoteWorkbench(StringNum: LongWord): LongBool;
type
  TLocalCall = function(StringNum: LongWord; LibBase: Pointer): LongBool; cdecl;
Var
  Call: TLocalCall;
Begin
...
function StartWorkbench(Flag: LongWord; Ptr: APTR): LongBool;
type
  TLocalCall = function(Flag: LongWord; Ptr: APTR; LibBase: Pointer): LongBool; cdecl;
Var
  Call: TLocalCall;
Begin
  Call := TLocalCall(GetLibAdress(WorkbenchBase, 7));
  StartWorkbench := Call(Flag, Ptr, WorkbenchBase);
End;


function AddAppWindowA(ID: LongWord; UserData: LongWord; Window: PWindow; MsgPort: PMsgPort; TagList: PTagItem): PAppWindow;
type
  TLocalCall = function(ID: LongWord; UserData: LongWord; Window: PWindow; MsgPort: PMsgPort; TagList: PTagItem; LibBase: Pointer): PAppWindow; cdecl;
Var
  Call: TLocalCall;
Begin
...
function RemoveAppWindow(AppWindow: PAppWindow): LongBool;
type
  TLocalCall = function(AppWindow: PAppWindow; LibBase: Pointer): LongBool; cdecl;
Var
  Call: TLocalCall;
Begin
...
function AddAppIconA(ID: LongWord; UserData: LongWord; Text_: PChar; MsgPort: PMsgPort; Lock: BPTR; DiskObj: PDiskObject; Taglist: PTagItem): PAppIcon;
type
  TLocalCall = function(ID: LongWord; UserData: LongWord; Text_: PChar; Msgport: PMsgPort; Lock: BPTR; Diskobj: PDiskObject; Taglist: PTagItem; LibBase: Pointer): PAppIcon; cdecl;
Var
  Call: TLocalCall;
Begin
...
function RemoveAppIcon(AppIcon: PAppIcon): LongBool;
type
  TLocalCall = function(AppIcon: PAppIcon; LibBase: Pointer): LongBool; cdecl;
Var
  Call: TLocalCall;
Begin
...
function AddAppMenuItemA(ID: LongWord; UserData: LongWord; Text_: APTR; MsgPort: PMsgPort; Taglist: PTagItem): PAppMenuItem;
type
  TLocalCall = function(ID: LongWord; UserData: LongWord; Text_: APTR; MsgPort: PMsgPort; TagList: PTagItem; LibBase: Pointer): PAppMenuItem; cdecl;
Var
  Call: TLocalCall;
Begin
...
function RemoveAppMenuItem(AppMenuItem: PAppMenuItem): LongBool;
type
  TLocalCall = function(AppMenuItem: PAppMenuItem; LibBase: Pointer): LongBool; cdecl;
Var
  Call: TLocalCall;
Begin
...
function WBConfig(Unk1: LongWord; Unk2: LongWord): LongBool;
type
  TLocalCall = function(Unk1: LongWord; Unk2: LongWord; LibBase: Pointer): LongBool; cdecl;
Var
  Call: TLocalCall;
Begin
...
function WBInfo(Lock: BPTR; const Name: STRPTR; Screen: PScreen): LongBool;
type
  TLocalCall = function(Lock: BPTR; const Name: STRPTR; Screen: PScreen; LibBase: Pointer): LongBool; cdecl;
Var
  Call: TLocalCall;
Begin
...
function OpenWorkbenchObjectA(Name: STRPTR; Tags: PTagItem): LongBool;
type
  TLocalCall = function(Name: STRPTR; Tags: PTagItem; LibBase: Pointer): LongBool; cdecl;
Var
  Call: TLocalCall;
Begin
...
function CloseWorkbenchObjectA(Name: STRPTR; Tags: PTagItem): LongBool;
type
  TLocalCall = function(Name: STRPTR; Tags: PTagItem; LibBase: Pointer): LongBool; cdecl;
Var
  Call: TLocalCall;
...
function AddAppWindowDropZoneA(Aw: PAppWindow; ID: LongWord; UserData: LongWord; Tags: PTagItem): PAppWindowDropZone;
type
  TLocalCall = function(Aw: PAppWindow; ID: LongWord; UserData: LongWord; Tags: PTagItem; LibBase: Pointer): PAppWindowDropZone; cdecl;
Var
  Call: TLocalCall;
Begin
...
function RemoveAppWindowDropZone(Aw: PAppWindow; DropZone: PAppWindowDropZone): LongBool;
type
  TLocalCall = function(Aw: PAppWindow; DropZone: PAppWindowDropZone; LibBase: Pointer): LongBool; cdecl;
Var
  Call: TLocalCall;
Begin
...
function ChangeWorkbenchSelectionA(Name: STRPTR; Hook: PHook; Tags: PTagItem): LongBool;
type
  TLocalCall = function(Name: STRPTR; Hook: PHook; Tags: PTagItem; LibBase: Pointer): LongBool; cdecl;
Var
  Call: TLocalCall;
Begin
...
function MakeWorkbenchObjectVisibleA(Name: STRPTR; Tags: PTagItem): LongBool;
type
  TLocalCall = function(Name: STRPTR; Tags: PTagItem; LibBase: Pointer): LongBool; cdecl;
Var
  Call: TLocalCall;
...
function RegisterWorkbench(MessagePort: PMsgPort): LongBool;
type
  TLocalCall = function(MessagePort: PMsgPort; LibBase: Pointer): LongBool; cdecl;
Var
  Call: TLocalCall;
Begin
...
function UpdateWorkbenchObjectA(Name: STRPTR; Type_: LongInt; Tags: PTagItem): LongBool;
type
  TLocalCall = function(Name: STRPTR; Type_: LongInt; Tags: PTagItem; LibBase: Pointer): LongBool; cdecl;
Var
  Call: TLocalCall;
Begin
...
function SendAppWindowMessage(Win: PWindow; NumFiles: LongWord; Files: PPChar; Class_: Word; MouseX: SmallInt; MouseY: SmallInt; Seconds: LongWord; Micros: LongWord): LongBool;
type
  TLocalCall = function(Win: PWindow; NumFiles: LongWord; Files: PPChar; Class_: Word; MouseX: SmallInt; MouseY: SmallInt; Seconds: LongWord; Micros: LongWord; LibBase: Pointer): LongBool; cdecl;
Var
  Call: TLocalCall;
Begin
...
function GetNextAppIcon(LastDiskObj: PDiskObject; Text_: PChar): PDiskObject;
type
  TLocalCall = function(LastDiskObj: PDiskObject; Text_: PChar; LibBase: Pointer): PDiskObject; cdecl;
Var
  Call: TLocalCall;
Begin
  Call := TLocalCall(GetLibAdress(WorkbenchBase, 27));
  GetNextAppIcon := Call(LastDiskObj, Text_, WorkbenchBase);
End;

...
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(MUIMasterBase, 5));
  MUI_NewObjectA := Call(class_, tags, MUIMasterBase);
end;
...
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(MUIMasterBase, 6));
  Call(obj, MUIMasterBase);
end;
...
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(MUIMasterBase, 7));
  MUI_RequestA := Call(app, win, flags, title, gadgets, format, params, MUIMasterBase);
end;
...
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(MUIMasterBase, 8));
  MUI_AllocAslRequest := Call(typ, tags, MUIMasterBase);
end;
...
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(MUIMasterBase, 9));
  MUI_AslRequest := Call(req, tags, MUIMasterBase);
end;
...
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(MUIMasterBase, 10));
  Call(req, MUIMasterBase);
end;
...
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(MUIMasterBase, 11));
  MUI_Error := Call(MUIMasterBase);
end;
...
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(MUIMasterBase, 12));
  MUI_SetError := Call(errnum, MUIMasterBase);
end;
...
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(MUIMasterBase, 13));
  MUI_GetClass := Call(name, MUIMasterBase);
end;
...
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(MUIMasterBase, 14));
  Call(cl, MUIMasterBase);
end;
...
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(MUIMasterBase, 15));
  Call(obj, flags, MUIMasterBase);
end;
...
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(MUIMasterBase, 16));
  Call(obj, flags, MUIMasterBase);
end;
...
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(MUIMasterBase, 17));
  Call(obj, flags, MUIMasterBase);
end;
...
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(MUIMasterBase, 18));
  Result := Call(base, supername, supermcc, datasize, dispatcher, MUIMasterBase);
end;
...
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(MUIMasterBase, 19));
  MUI_DeleteCustomClass := Call(mcc, MUIMasterBase);
end;
...
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(MUIMasterBase, 20));
  MUI_MakeObjectA := Call(typ, params, MUIMasterBase);
end;
...
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(MUIMasterBase, 21));
  MUI_Layout := Call(obj, l, t, w, h, flags, MUIMasterBase);
end;
...
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(MUIMasterBase, 22));
  MUI_ObtainPen := Call(mri, spec, flags, MUIMasterBase);
end;
...
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(MUIMasterBase, 23));
  Call(mri, pen, MUIMasterBase);
end;
...
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(MUIMasterBase, 24));
  MUI_AddClipping := Call(mri, l, t, w, h, MUIMasterBase);
end;
...
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(MUIMasterBase, 25));
  Call(mri, h, MUIMasterBase);
end;
...
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(MUIMasterBase, 26));
  MUI_AddClipRegion := Call(mri, region, MUIMasterBase);
end;
...
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(MUIMasterBase, 27));
  Call(mri, region, MUIMasterBase);
end;
...
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(MUIMasterBase, 28));
  MUI_BeginRefresh := Call(mri, flags, MUIMasterBase);
end;
...
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(MUIMasterBase, 29));
  Call(mri, flags, MUIMasterBase);
end;

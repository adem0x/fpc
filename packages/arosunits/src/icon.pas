...
function AddFreeList(FreeList: PFreeList; const Mem: APTR; Size: ULONG): BOOL; // 12
function BumpRevision(NewName: PChar; const OldName: PChar): PChar; // 18
function DeleteDiskObject(const Name: PChar): BOOL;
function FindToolType(const ToolTypeArray: PPChar; const TypeName: STRPTR): STRPTR; // 16
procedure FreeDiskObject(DiskObj: PDiskObject); // 15
procedure FreeFreeList(FreeList: PFreeList); // 9
function GetDefDiskObject(Typ: LongInt): PDiskObject; // 20
function GetDiskObject(const Name: STRPTR): PDiskObject; // 13
function GetDiskObjectNew(const Name : PChar): PDiskObject; // 22
function MatchToolValue(const TypeString: PChar; const Value: PChar): BOOL; // 17
function PutDefDiskObject(const Icon: PDiskObject): BOOL; // 21
function PutDiskObject(const Name: STRPTR; const Icon: PDiskObject): BOOL; // 14

{ version 44 }
function DupDiskObjectA(const Icon: PDiskObject; const Tags: PTagItem): PDiskObject; // 25
function IconControlA(Icon: PDiskObject; const Tags: PTagItem): ULONG;  // 26
procedure DrawIconStateA(Rp: PRastPort; const Icon: PDiskObject; const Label_: STRPTR;
  LeftEdge: LongInt; TopEdge: LongInt; State: ULONG; const Tags: PTagItem);  // 27
function GetIconRectangleA(Rp: PRastPort; const Icon: PDiskObject; const Label_: PChar;
  Rect: PRectangle; const Tags: PTagItem): BOOL;  // 28
function NewDiskObject(Type_: ULONG): PDiskObject; // 29
function GetIconTagList(const Name: STRPTR; const Tags: PTagItem): PDiskObject; //30
function PutIconTagList(const Name: STRPTR; const Icon: PDiskObject; const Tags: PTagItem): BOOL; // 31
function LayoutIconA(Icon: PDiskObject; Screen: PScreen; Tags: PTagItem): BOOL; // 32
procedure ChangeToSelectedIconColor(Cr: Pointer); //TODO: pColorRegister  // 33
...
function AddFreeList(FreeList: PFreeList; const Mem: APTR; Size: ULONG): BOOL;
type
  TLocalCall = function(FreeList: PFreeList; const Mem: APTR; Size: ULONG; Base: Pointer): BOOL; cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(IconBase, 12));
  AddFreeList := Call(FreeList,Mem, Size, IconBase);
end;

function BumpRevision(NewName: PChar; const OldName: PChar): PChar;
type
  TLocalCall = function(NewName: PChar; const OldName: PChar; Base: Pointer): PChar; cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(IconBase, 18));
  BumpRevision := Call(NewName, OldName, IconBase);
end;

function DeleteDiskObject(const Name: PChar): BOOL; // 23
type
  TLocalCall = function(const Name: PChar; Base: Pointer): BOOL; cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(IconBase, 23));
  DeleteDiskObject := Call(Name, IconBase);
end;

function FindToolType(const ToolTypeArray: PPChar; const TypeName: STRPTR): STRPTR; // 16
type
  TLocalCall = function(const ToolTypeArray: PPChar; const TypeName: STRPTR; Base: Pointer): STRPTR; cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(IconBase, 16));
  FindToolType := Call(ToolTypeArray, TypeName, IconBase);
end;

procedure FreeDiskObject(DiskObj: PDiskObject); // 15
type
  TLocalCall = procedure(DiskObj: PDiskObject; Base: Pointer); cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(IconBase, 15));
  Call(DiskObj, IconBase);
end;

procedure FreeFreeList(FreeList: PFreeList); // 9
type
  TLocalCall = procedure(FreeList: PFreeList; Base: Pointer); cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(IconBase, 9));
  Call(FreeList, IconBase);
end;

function GetDefDiskObject(Typ: LongInt): PDiskObject; // 20
type
  TLocalCall = function(Typ: LongInt; Base: Pointer): PDiskObject; cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(IconBase, 20));
  GetDefDiskObject := Call(Typ, IconBase);
end;

function GetDiskObject(const Name: STRPTR): PDiskObject; // 13
type
  TLocalCall = function(const Name: STRPTR; Base: Pointer): PDiskObject; cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(IconBase, 13));
  GetDiskObject := Call(Name, IconBase);
end;

function GetDiskObjectNew(const Name : PChar): PDiskObject; // 22
type
  TLocalCall = function(const Name: PChar; Base: Pointer): PDiskObject; cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(IconBase, 22));
  GetDiskObjectNew := Call(Name, IconBase);
end;

function MatchToolValue(const TypeString: PChar; const Value: PChar): BOOL; // 17
type
  TLocalCall = function(const TypeString: PChar; const Value: PChar; Base: Pointer): BOOL; cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(IconBase, 17));
  MatchToolValue := Call(TypeString, Value, IconBase);
end;

function PutDefDiskObject(const Icon: PDiskObject): BOOL; // 21
type
  TLocalCall = function(const Icon: PDiskObject; Base: Pointer): BOOL; cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(IconBase, 21));
  PutDefDiskObject := Call(Icon, IconBase);
end;

function PutDiskObject(const Name: STRPTR; const Icon: PDiskObject): BOOL; // 14
type
  TLocalCall = function(const Name: STRPTR; const Icon: PDiskObject; Base: Pointer): BOOL; cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(IconBase, 14));
  PutDiskObject := Call(Name, Icon, IconBase);
end;

{ version 44 }
function DupDiskObjectA(const Icon: PDiskObject; const Tags: PTagItem): PDiskObject; // 25
type
  TLocalCall = function(const Icon: PDiskObject; const Tags: PTagItem; Base: Pointer): PDiskObject; cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(IconBase, 25));
  DupDiskObjectA := Call(Icon, Tags, IconBase);
end;

function IconControlA(Icon: PDiskObject; const Tags: PTagItem): ULONG;  // 26
type
  TLocalCall = function(Icon: PDiskObject; const Tags: PTagItem; Base: Pointer): ULONG; cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(IconBase, 26));
  IconControlA := Call(Icon, Tags, IconBase);
end;

procedure DrawIconStateA(Rp: PRastPort; const Icon: PDiskObject; const Label_: STRPTR;
  LeftEdge: LongInt; TopEdge: LongInt; State: ULONG; const Tags: PTagItem);  // 27
type
  TLocalCall = procedure(Rp: PRastPort; const Icon: PDiskObject; const Label_: STRPTR;
  LeftEdge: LongInt; TopEdge: LongInt; State: ULONG; const Tags: PTagItem; Base: Pointer); cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(IconBase, 27));
  Call(Rp, Icon, Label_, LeftEdge, TopEdge, State, Tags, IconBase);
end;

function GetIconRectangleA(Rp: PRastPort; const Icon: PDiskObject; const Label_: PChar;
  Rect: PRectangle; const Tags: PTagItem): BOOL;  // 28
type
  TLocalCall = function(Rp: PRastPort; const Icon: PDiskObject; const Label_: PChar;
  Rect: PRectangle; const Tags: PTagItem; Base: Pointer): BOOL; cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(IconBase, 28));
  GetIconRectangleA := Call(Rp, Icon, Label_, Rect, Tags, IconBase);
end;  
  
function NewDiskObject(Type_: ULONG): PDiskObject; // 29
type
  TLocalCall = function(Type_: ULONG; Base: Pointer): PDiskObject; cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(IconBase, 29));
  NewDiskObject := Call(Type_, IconBase);
end;

function GetIconTagList(const Name: STRPTR; const Tags: PTagItem): PDiskObject; //30
type
  TLocalCall = function(const Name: STRPTR; const Tags: PTagItem; Base: Pointer): PDiskObject; cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(IconBase, 30));
  GetIconTagList := Call(Name, Tags, IconBase);
end;


function PutIconTagList(const Name: STRPTR; const Icon: PDiskObject; const Tags: PTagItem): BOOL; // 31
type
  TLocalCall = function(const Name: STRPTR; const Icon: PDiskObject; const Tags: PTagItem; Base: Pointer): BOOL; cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(IconBase, 31));
  PutIconTagList := Call(Name, Icon, Tags, IconBase);
end;

function LayoutIconA(Icon: PDiskObject; Screen: PScreen; Tags: PTagItem): BOOL; // 32
type
  TLocalCall = function(Icon: PDiskObject; Screen: PScreen; Tags: PTagItem; Base: Pointer): BOOL; cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(IconBase, 32));
  LayoutIconA := Call(Icon, Screen, Tags, IconBase);
end;


procedure ChangeToSelectedIconColor(Cr: Pointer); //TODO: pColorRegister  // 33
type
  TLocalCall = procedure(Cr: Pointer; Base: Pointer); cdecl;
var
  Call: TLocalCall;
begin
  Call := TLocalCall(GetLibAdress(IconBase, 33));
  Call(Cr, IconBase);
end;

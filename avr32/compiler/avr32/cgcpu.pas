...
{$i fpcdefs.inc}
  ...
  implementation
    ...
    function tcgavr32.getmmregister(list: TAsmList; size: Tcgsize): Tregister;
     ...
     procedure tcgavr32.a_load_const_reg(list : TAsmList; size: tcgsize; a : aint;reg : tregister);
       var
          imm_shift : byte;
          l : tasmlabel;
          hr : treference;
    ...
    procedure tcgavr32.a_load_const_cgpara(list : TAsmList;size : tcgsize;a : aint;const paraloc : TCGPara);
      var
        ref: treference;
        treg: TRegister;
      begin
        ...
        list.concat(taicpu.op_reg(A_ICALL, reg));
{
    ...
    procedure tcgavr32.a_call_ref(list : TAsmList;ref: treference);
     ...
     procedure tcgavr32.a_op_const_reg(list : TAsmList; Op: TOpCG; size: TCGSize; a: aint; reg: TRegister);
       begin
    ...
    procedure tcgavr32.a_op_const_reg_reg(list: TAsmList; op: TOpCg;
    ...
    procedure tcgavr32.a_op_const_reg_reg_checkoverflow(list: TAsmList; op: TOpCg; size: tcgsize; a: aint; src, dst: tregister;setflags : boolean;var ovloc : tlocation);
      var
        shift : byte;
        tmpreg : tregister;
        so : tshifterop;
    ...
    {  comparison operations }
    procedure tcgavr32.a_cmp_const_reg_label(list : TAsmList;size : tcgsize;cmp_op : topcmp;a : aint;reg : tregister;
      l : tasmlabel);
      var
        tmpreg : tregister;
        b : byte;
    ...
    procedure tcgavr32.g_concatcopy_move(list : TAsmList;const source,dest : treference;len : aint);
      var
    ...
    procedure tcgavr32.g_concatcopy_internal(list : TAsmList;const source,dest : treference;len : aint;aligned : boolean);
      const
...
//            if cs_opt_size in current_settings.optimizerswitches  then
    ...
    procedure tcgavr32.g_concatcopy_unaligned(list : TAsmList;const source,dest : treference;len : aint);
      begin
        g_concatcopy_internal(list,source,dest,len,false);
      end;


    procedure tcgavr32.g_concatcopy(list : TAsmList;const source,dest : treference;len : aint);
      begin
    ...
    procedure tcgavr32.g_adjust_self_value(list:TAsmList;procdef: tprocdef;ioffset: aint);
      var
        hsym : tsym;
        href : treference;

...
{ change movl  %reg1,%reg2 ... bla ... to ... bla with reg1 and reg2 switched, handles
    ...
    begin
      ...
      If tmpResult and
        ...
        begin
          ...
          reg1StillUsed := reg1 in pTaiprop(endp.optinfo)^.usedregs[R_INTREGISTER];
          reg2StillUsed := reg2 in pTaiprop(endp.optinfo)^.usedregs[R_INTREGISTER];
